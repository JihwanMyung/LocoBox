...
global LightIntensity_1, LightIntensity_2
global LightIntensity_3, LightIntensity_4
global LightIntensity_5, LightIntensity_6
global LightIntensity_7, LightIntensity_8
global LightIntensity_9, LightIntensity_10
global LightIntensity_11, LightIntensity_12
global LightIntensity_13, LightIntensity_14
global LightIntensity_15, LightIntensity_16
global LightIntensity_17, LightIntensity_18
global LightIntensity_19, LightIntensity_20
...
def get_data(istate=0):  # Start recording
    ...
    while True:
        ...
        if i == 2:
            ...
            serial_obj.write(str.encode(dark_1[0] + light_1[0] + dark_1[1] + light_1[1] +

                                        dark_2[0] + light_2[0] + dark_2[1] + light_2[1] +

                                        dark_3[0] + light_3[0] + dark_3[1] + light_3[1]))

        if i == 3:

            serial_obj.write(str.encode(hourOn_1[0] + minOn_1[0] + hourOn_1[1] + minOn_1[1] + 

                                        ratio_on_1[0] + ratio_off_1[0] + ratio_on_1[1] + ratio_off_1[1]))

        if i == 4:

            serial_obj.write(str.encode(hourOn_2[0] + minOn_2[0] + hourOn_2[1] + minOn_2[1] + 
                                        LightIntensity_1[0] + LightIntensity_1[1] + LightIntensity_2[0] + LightIntensity_2[1] + 
                                        LightIntensity_3[0] + LightIntensity_3[1] + LightIntensity_4[0] + LightIntensity_4[1] + 
                                        LightIntensity_5[0] + LightIntensity_5[1] + LightIntensity_6[0] + LightIntensity_6[1] +
                                        LightIntensity_7[0] + LightIntensity_7[1] + LightIntensity_8[0] + LightIntensity_8[1] + 
                                        LightIntensity_9[0] + LightIntensity_9[1] + LightIntensity_10[0] + LightIntensity_10[1] +
                                        LightIntensity_11[0] + LightIntensity_11[1] + LightIntensity_12[0] + LightIntensity_12[1] +
                                        LightIntensity_13[0] + LightIntensity_13[1] + LightIntensity_14[0] + LightIntensity_14[1] +
                                        LightIntensity_15[0] + LightIntensity_15[1] + LightIntensity_16[0] + LightIntensity_16[1]))

        if i == 5:

            serial_obj.write(str.encode(ratio_on_2[0] + ratio_off_2[0] + ratio_on_2[1] + ratio_off_2[1] + 

                                        hourOn_3[0] + minOn_3[0] + hourOn_3[1] + minOn_3[1] + 
                                        LightIntensity_17[0] + LightIntensity_17[1] + LightIntensity_18[0] + LightIntensity_18[1] + 
                                        LightIntensity_19[0] + LightIntensity_19[1] + LightIntensity_20[0] + LightIntensity_20[1]))

        if i == 6:

            serial_obj.write(str.encode(ratio_on_3[0] + ratio_off_3[0] + ratio_on_3[1] + ratio_off_3[1]))
        if i == 7:

            serial_obj.write(str.encode(dark_4[0] + light_4[0] + dark_4[1] + light_4[1] + 

                                        dark_5[0] + light_5[0] + dark_5[1] + light_5[1] +

                                        dark_6[0] + light_6[0] + dark_6[1] + light_6[1]))
        if i == 8:

            serial_obj.write(str.encode(dark_7[0] + light_7[0] + dark_7[1] + light_7[1] + 

                                        dark_8[0] + light_8[0] + dark_8[1] + light_8[1] + 

                                        dark_9[0] + light_9[0] + dark_9[1] + light_9[1]))
        if i == 9:

            serial_obj.write(str.encode(dark_10[0] + light_10[0] + dark_10[1] + light_10[1] + 

                                        dark_11[0] + light_11[0] + dark_11[1] + light_11[1] +

                                        dark_12[0] + light_12[0] + dark_12[1] + light_12[1]))
        if i == 10:

            serial_obj.write(str.encode(dark_13[0] + light_13[0] + dark_13[1] + light_13[1] + 

                                        dark_14[0] + light_14[0] + dark_14[1] + light_14[1] + 

                                        dark_15[0] + light_15[0] + dark_15[1] + light_15[1]))

        if i == 11:

            serial_obj.write(str.encode(dark_16[0] + light_16[0] + dark_16[1] + light_16[1] + 

                                        dark_17[0] + light_17[0] + dark_17[1] + light_17[1] +

                                        dark_18[0] + light_18[0] + dark_18[1] + light_18[1]))

        if i == 12:
            serial_obj.write(str.encode(dark_19[0] + light_19[0] + dark_19[1] + light_19[1] +

                                        dark_20[0] + light_20[0] + dark_20[1] + light_20[1]))

        if i == 13:
            serial_obj.write(str.encode(hourOn_4[0] + minOn_4[0] + hourOn_4[1] + minOn_4[1] +

                                        ratio_on_4[0] + ratio_off_4[0] + ratio_on_4[1] + ratio_off_4[1]))

        if i == 14:
            serial_obj.write(str.encode(hourOn_5[0] + minOn_5[0] + hourOn_5[1] + minOn_5[1]))

        if i == 15:
            serial_obj.write(str.encode(ratio_on_5[0] + ratio_off_5[0] + ratio_on_5[1] + ratio_off_5[1] +

                                        hourOn_6[0] + minOn_6[0] + hourOn_6[1] + minOn_6[1]))
        if i == 16:
            serial_obj.write(str.encode(ratio_on_6[0] + ratio_off_6[0] + ratio_on_6[1] + ratio_off_6[1]))

        if i == 17:
            serial_obj.write(str.encode(hourOn_7[0] + minOn_7[0] + hourOn_7[1] + minOn_7[1] +

                                        ratio_on_7[0] + ratio_off_7[0] + ratio_on_7[1] + ratio_off_7[1]))
                                        
        if i == 18:
            serial_obj.write(str.encode(hourOn_8[0] + minOn_8[0] + hourOn_8[1] + minOn_8[1]))

        if i == 19:
            serial_obj.write(str.encode(ratio_on_8[0] + ratio_off_8[0] + ratio_on_8[1] + ratio_off_8[1] + 

                                        hourOn_9[0] + minOn_9[0] + hourOn_9[1] + minOn_9[1]))
        if i == 20:
            serial_obj.write(str.encode(ratio_on_9[0] + ratio_off_9[0] + ratio_on_9[1] + ratio_off_9[1]))

        if i == 21:
            serial_obj.write(str.encode(hourOn_10[0] + minOn_10[0] + hourOn_10[1] + minOn_10[1] + 

                                        ratio_on_10[0] + ratio_off_10[0] + ratio_on_10[1] + ratio_off_10[1]))
        if i == 22:
            serial_obj.write(str.encode(hourOn_11[0] + minOn_11[0] + hourOn_11[1] + minOn_11[1]))

        if i == 23:
            serial_obj.write(str.encode(ratio_on_11[0] + ratio_off_11[0] + ratio_on_11[1] + ratio_off_11[1] + 

                                        hourOn_12[0] + minOn_12[0] + hourOn_12[1] + minOn_12[1]))
        if i == 24:
            serial_obj.write(str.encode(ratio_on_12[0] + ratio_off_12[0] + ratio_on_12[1] + ratio_off_12[1]))

        if i == 25:
            serial_obj.write(str.encode(hourOn_13[0] + minOn_13[0] + hourOn_13[1] + minOn_13[1] + 

                                        ratio_on_13[0] + ratio_off_13[0] + ratio_on_13[1] + ratio_off_13[1]))

        if i == 26:
            serial_obj.write(str.encode(hourOn_14[0] + minOn_14[0] + hourOn_14[1] + minOn_14[1]))

        if i == 27:
            serial_obj.write(str.encode(ratio_on_14[0] + ratio_off_14[0] + ratio_on_14[1] + ratio_off_14[1] +

                                        hourOn_15[0] + minOn_15[0] + hourOn_15[1] + minOn_15[1]))
        if i == 28:
            serial_obj.write(str.encode(ratio_on_15[0] + ratio_off_15[0] + ratio_on_15[1] + ratio_off_15[1]))
        if i == 29:
            serial_obj.write(str.encode(hourOn_16[0] + minOn_16[0] + hourOn_16[1] + minOn_16[1] +

                                        ratio_on_16[0] + ratio_off_16[0] + ratio_on_16[1] + ratio_off_16[1]))
        if i == 30:
            serial_obj.write(str.encode(hourOn_17[0] + minOn_17[0] + hourOn_17[1] + minOn_17[1]))

        if i == 31:
            serial_obj.write(str.encode(ratio_on_17[0] + ratio_off_17[0] + ratio_on_17[1] + ratio_off_17[1] +

                                        hourOn_18[0] + minOn_18[0] + hourOn_18[1] + minOn_18[1]))
        if i == 32:
            serial_obj.write(str.encode(ratio_on_18[0] + ratio_off_18[0] + ratio_on_18[1] + ratio_off_18[1]))
        if i == 33:
            serial_obj.write(str.encode(hourOn_19[0] + minOn_19[0] + hourOn_19[1] + minOn_19[1] +

                                        ratio_on_19[0] + ratio_off_19[0] + ratio_on_19[1] + ratio_off_19[1]))
        if i == 34:
            serial_obj.write(str.encode(hourOn_20[0] + minOn_20[0] + hourOn_20[1] + minOn_20[1]))

        if i == 35:
            serial_obj.write(str.encode(ratio_on_20[0] + ratio_off_20[0] + ratio_on_20[1] + ratio_off_20[1]))
        if i == 36:
...
def getAllBoxSchedule():
    ...
    for i in range(2):
        ...
        LightIntensity_1.append(LightSpin1[i].get())
        LightIntensity_2.append(LightSpin2[i].get())
        LightIntensity_3.append(LightSpin3[i].get())
        LightIntensity_4.append(LightSpin4[i].get())
        LightIntensity_5.append(LightSpin5[i].get())

        LightIntensity_6.append(LightSpin6[i].get())
        LightIntensity_7.append(LightSpin7[i].get())
        LightIntensity_8.append(LightSpin8[i].get())
        LightIntensity_9.append(LightSpin9[i].get())
        LightIntensity_10.append(LightSpin10[i].get())

        LightIntensity_11.append(LightSpin11[i].get())
        LightIntensity_12.append(LightSpin12[i].get())
        LightIntensity_13.append(LightSpin13[i].get())
        LightIntensity_14.append(LightSpin14[i].get())
        LightIntensity_15.append(LightSpin15[i].get())
        
        LightIntensity_16.append(LightSpin16[i].get())
        LightIntensity_17.append(LightSpin17[i].get())
        LightIntensity_18.append(LightSpin18[i].get())
        LightIntensity_19.append(LightSpin19[i].get())
        LightIntensity_20.append(LightSpin20[i].get())
...
if __name__ == '__main__':
    ...
    for i in range(2):
        ...
        LightSpin1.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin2.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin3.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin4.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin5.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))

        LightSpin6.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin7.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin8.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin9.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin10.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))

        LightSpin11.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin12.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin13.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin14.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin15.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))

        LightSpin16.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin17.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin18.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin19.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))
        LightSpin20.append(Spinbox(tab[i], from_=1, to=4, width=2, format='%01.0f'))

        LightLabel1.append((Label(tab[i], text='Light Intensity')))
        LightLabel2.append((Label(tab[i], text='Light Intensity')))
        LightLabel3.append((Label(tab[i], text='Light Intensity')))
        LightLabel4.append((Label(tab[i], text='Light Intensity')))
        LightLabel5.append((Label(tab[i], text='Light Intensity')))

        LightLabel6.append((Label(tab[i], text='Light Intensity')))
        LightLabel7.append((Label(tab[i], text='Light Intensity')))
        LightLabel8.append((Label(tab[i], text='Light Intensity')))
        LightLabel9.append((Label(tab[i], text='Light Intensity')))
        LightLabel10.append((Label(tab[i], text='Light Intensity')))

        LightLabel11.append((Label(tab[i], text='Light Intensity')))
        LightLabel12.append((Label(tab[i], text='Light Intensity')))
        LightLabel13.append((Label(tab[i], text='Light Intensity')))
        LightLabel14.append((Label(tab[i], text='Light Intensity')))
        LightLabel15.append((Label(tab[i], text='Light Intensity')))

        LightLabel16.append((Label(tab[i], text='Light Intensity')))
        LightLabel17.append((Label(tab[i], text='Light Intensity')))
        LightLabel18.append((Label(tab[i], text='Light Intensity')))
        LightLabel19.append((Label(tab[i], text='Light Intensity')))
        LightLabel20.append((Label(tab[i], text='Light Intensity')))
    ...
    for i in boxes:
        ...
        LightSpin1[i].delete(0,'end')
        LightSpin1[i].insert(0,'1')
        LightSpin2[i].delete(0,'end')
        LightSpin2[i].insert(0,'1')
        LightSpin3[i].delete(0,'end')
        LightSpin3[i].insert(0,'1')
        LightSpin4[i].delete(0,'end')
        LightSpin4[i].insert(0,'1')
        LightSpin5[i].delete(0,'end')
        LightSpin5[i].insert(0,'1')

        LightSpin6[i].delete(0,'end')
        LightSpin6[i].insert(0,'1')
        LightSpin7[i].delete(0,'end')
        LightSpin7[i].insert(0,'1')
        LightSpin8[i].delete(0,'end')
        LightSpin8[i].insert(0,'1')
        LightSpin9[i].delete(0,'end')
        LightSpin9[i].insert(0,'1')
        LightSpin10[i].delete(0,'end')
        LightSpin10[i].insert(0,'1')

        LightSpin11[i].delete(0,'end')
        LightSpin11[i].insert(0,'1')
        LightSpin12[i].delete(0,'end')
        LightSpin12[i].insert(0,'1')
        LightSpin13[i].delete(0,'end')
        LightSpin13[i].insert(0,'1')
        LightSpin14[i].delete(0,'end')
        LightSpin14[i].insert(0,'1')
        LightSpin15[i].delete(0,'end')
        LightSpin15[i].insert(0,'1')

        LightSpin16[i].delete(0,'end')
        LightSpin16[i].insert(0,'1')
        LightSpin17[i].delete(0,'end')
        LightSpin17[i].insert(0,'1')
        LightSpin18[i].delete(0,'end')
        LightSpin18[i].insert(0,'1')
        LightSpin19[i].delete(0,'end')
        LightSpin19[i].insert(0,'1')
        LightSpin20[i].delete(0,'end')
        LightSpin20[i].insert(0,'1')

        LightSpin1[i].grid(column=13, row=1+row_adj, pady=5)
        LightSpin2[i].grid(column=13, row=2+row_adj, pady=5)
        LightSpin3[i].grid(column=13, row=3+row_adj, pady=5)
        LightSpin4[i].grid(column=13, row=4+row_adj, pady=5)
        LightSpin5[i].grid(column=13, row=5+row_adj, pady=5)

        LightSpin6[i].grid(column=13, row=6+row_adj, pady=5)
        LightSpin7[i].grid(column=13, row=7+row_adj, pady=5)
        LightSpin8[i].grid(column=13, row=8+row_adj, pady=5)
        LightSpin9[i].grid(column=13, row=9+row_adj, pady=5)
        LightSpin10[i].grid(column=13, row=10+row_adj, pady=5)

        LightSpin11[i].grid(column=13, row=11+row_adj, pady=5)
        LightSpin12[i].grid(column=13, row=12+row_adj, pady=5)
        LightSpin13[i].grid(column=13, row=13+row_adj, pady=5)
        LightSpin14[i].grid(column=13, row=14+row_adj, pady=5)
        LightSpin15[i].grid(column=13, row=15+row_adj, pady=5)

        LightSpin16[i].grid(column=13, row=16+row_adj, pady=5)
        LightSpin17[i].grid(column=13, row=17+row_adj, pady=5)
        LightSpin18[i].grid(column=13, row=18+row_adj, pady=5)
        LightSpin19[i].grid(column=13, row=19+row_adj, pady=5)
        LightSpin20[i].grid(column=13, row=20+row_adj, pady=5)

        LightLabel1[i].grid(column=12, row=1+row_adj, pady=5)
        LightLabel2[i].grid(column=12, row=2+row_adj, pady=5)
        LightLabel3[i].grid(column=12, row=3+row_adj, pady=5)
        LightLabel4[i].grid(column=12, row=4+row_adj, pady=5)
        LightLabel5[i].grid(column=12, row=5+row_adj, pady=5)
        LightLabel6[i].grid(column=12, row=6+row_adj, pady=5)
        LightLabel7[i].grid(column=12, row=7+row_adj, pady=5)
        LightLabel8[i].grid(column=12, row=8+row_adj, pady=5)
        LightLabel9[i].grid(column=12, row=9+row_adj, pady=5)
        LightLabel10[i].grid(column=12, row=10+row_adj, pady=5)
        LightLabel11[i].grid(column=12, row=11+row_adj, pady=5)
        LightLabel12[i].grid(column=12, row=12+row_adj, pady=5)
        LightLabel13[i].grid(column=12, row=13+row_adj, pady=5)
        LightLabel14[i].grid(column=12, row=14+row_adj, pady=5)
        LightLabel15[i].grid(column=12, row=15+row_adj, pady=5)
        LightLabel16[i].grid(column=12, row=16+row_adj, pady=5)
        LightLabel17[i].grid(column=12, row=17+row_adj, pady=5)
        LightLabel18[i].grid(column=12, row=18+row_adj, pady=5)
        LightLabel19[i].grid(column=12, row=19+row_adj, pady=5)
        LightLabel20[i].grid(column=12, row=20+row_adj, pady=5)
        ...
        tab_title2[i].grid(column=12, row=row_adj+21,
                           columnspan='27', sticky='we')

        boxrec_text[i].set('Recording not started yet.')

        boxrec_stat[i].grid(column=12, row=row_adj+22,
                            columnspan='27', sticky='we')
