...
window = Tk()
window.title('LocoBox12 (Boxes #6-#10)')
...
def get_data(istate=0): # Start recording
    ...
    try:
        while True:
            ...
            if len(string2)>=79:               
                box1rec_text.set('# '+str(counti)+'    Time: '+string2[0:8]+'    LED6: '+string2[20:25]+'    '+'PIR6: '+string2[26:31])
                box2rec_text.set('# '+str(counti)+'    Time: '+string2[0:8]+'    LED7: '+string2[32:37]+'    '+'PIR7: '+string2[38:43])
                box3rec_text.set('# '+str(counti)+'    Time: '+string2[0:8]+'    LED8: '+string2[44:49]+'    '+'PIR8: '+string2[50:55])
                box4rec_text.set('# '+str(counti)+'    Time: '+string2[0:8]+'    LED9: '+string2[56:61]+'    '+'PIR9: '+string2[62:67])
                box5rec_text.set('# '+str(counti)+'    Time: '+string2[0:8]+'    LE10: '+string2[68:73]+'    '+'PI10: '+string2[74:79])
...
def read_conf(): # Read schedule configuration
    ...
    box1sched_text.set('Box6 schedule loaded.')
    box2sched_text.set('Box7 schedule loaded.')
    box3sched_text.set('Box8 schedule loaded.')
    box4sched_text.set('Box9 schedule loaded.')
    box5sched_text.set('Bx10 schedule loaded.')
...
def getBox1Schedule(): 
    ...
    box1sched_text.set('Box6 schedule set.')
...
def getBox2Schedule(): 
    ...
    box2sched_text.set('Box7 schedule set.')
    if setBox1+setBox2+setBox3+setBox4+setBox5 == 5:
        btnSave['state']='normal'
        btnRun['state']='normal'
        recordingmenu.entryconfig('Start new', state='normal')
...
def getBox3Schedule(): 
    ...
    box3sched_text.set('Box8 schedule set.')
    if setBox1+setBox2+setBox3+setBox4+setBox5 == 5:
        btnSave['state']='normal'
        btnRun['state']='normal'
        recordingmenu.entryconfig('Start new', state='normal')
...
def getBox4Schedule(): 
    ...
    box4sched_text.set('Box9 schedule set.')
    if setBox1+setBox2+setBox3+setBox4+setBox5 == 5:
        btnSave['state']='normal'
        btnRun['state']='normal'
        recordingmenu.entryconfig('Start new', state='normal')
...
def getBox5Schedule(): 
    ...
    box5sched_text.set('Box10 schedule set.')
    if setBox1+setBox2+setBox3+setBox4+setBox5 == 5:
        btnSave['state']='normal'
        btnRun['state']='normal'
        recordingmenu.entryconfig('Start new', state='normal')
...
def getAllBoxSchedule(): 
    ...
    getBox5Schedule()
    status.pack(side='bottom', fill='x')
    status.set('Schedules for boxes #6-10 are set.')
    show_conf()
    btnSave['state']='normal'
    btnRun['state']='normal'
    recordingmenu.entryconfig('Start new', state='normal')
...
if __name__ == '__main__':
    ...
    tab_control.add(ParentFrame5, text='Bx10')
    ...
    Label(text =  'Baud rate').place(x = 363, y = 270)
    Label(text = 'Time out').place(x= 565, y=270)
