...
if __name__ == '__main__':
    ...
    row11_1.grid(column=1,row=2,padx=2,pady=2)
    row11_2.grid(column=1,row=3,padx=2,pady=2)
    row11_3.grid(column=1,row=4,padx=2,pady=2)
    row11_4.grid(column=1,row=5,padx=2,pady=2)
    row11_5.grid(column=1,row=6,padx=2,pady=2)
    row11_6.grid(column=1,row=7,padx=2,pady=2)
    row11_7.grid(column=1,row=8,padx=2,pady=2)
    row11_8.grid(column=1,row=9,padx=2,pady=2)
    row11_9.grid(column=1,row=10,padx=2,pady=2)
    row11_10.grid(column=1,row=11,padx=2,pady=2)
