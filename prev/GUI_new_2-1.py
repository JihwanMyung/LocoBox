import serial   # SFor Serial communication
...
window = Tk()
window.title('BOX1 (1-LED, 10-box)')
window.geometry('1060x440')
...
if __name__ == "__main__":
    ...
    port   = Label(text = 'Port').place(x = 40, y = 340)
    baud   = Label(text = 'Baud').place(x = 40, y = 380)
    timeout = Label(text = 'Timeout').place(x= 200, y=340)
    filename = Label(text= 'Filename').place(x=200, y=380)

    
    port_entry = Entry(width = 6)
    port_entry.place(x = 85, y = 340)
    port_entry.insert(0,"COM3")
    baud_entry = Entry(width = 6)
    baud_entry.place(x = 85, y = 380)
    baud_entry.insert(0,"9600")
    timeout_entry = Entry(width = 3)
    timeout_entry.place(x=270,y=340)
    timeout_entry.insert(0,"10")
    
    filename_entry = Entry(width = 20)
    filename_entry.place(x=270,y=380)
    ...
    dateLabel = time.strftime('%H h %M m  %Y / %m / %d') # reads time for Phase 1 start-time
    fromLabel1_1=Label(tab1, text='From:')
    date_label1 = Label(tab1, text=dateLabel+'  (YYYY/MM/DD)')
    rad1_A_1 = Radiobutton(tab1, text='LD', variable=var1_1, value=1)
    lbl1_A_1 = Label(tab1, text= 'On:')
    spin1_A_1 = Spinbox(tab1, from_=00, to=24, width=3)
    spin1_B_1 = Spinbox(tab1, from_=00, to=59, width=3)
    ...
    spin1_C_1 = Spinbox(tab1, from_=00, to=24, width=3)
    spin1_D_1 = Spinbox(tab1, from_=00, to=59, width=3)
    ...
    spin1_E_2 = Spinbox(tab1, from_=00, to=24, width=3)
    spin1_F_2 = Spinbox(tab1, from_=00, to=59, width=3)
    ...
    date1_2_entry = Spinbox(tab1, from_=00, to=31, width=3)
    month1_2_entry = Spinbox(tab1, from_=00, to=12, width=3)
    ...
    date1_2_entry.insert(0,day_phase2.day)
    month1_2_entry.delete(0,"end")
    month1_2_entry.insert(0,day_phase2.month)
    ...
    spin1_A_2 = Spinbox(tab1, from_=00, to=24, width=3)
    spin1_B_2 = Spinbox(tab1, from_=00, to=59, width=3)
    ...
    spin1_C_2 = Spinbox(tab1, from_=00, to=24, width=3)
    spin1_D_2 = Spinbox(tab1, from_=00, to=59, width=3)
    ...
    spin1_E_3 = Spinbox(tab1, from_=00, to=24, width=3)
    spin1_F_3 = Spinbox(tab1, from_=00, to=59, width=3)
    ...
    date1_3_entry = Spinbox(tab1, from_=00, to=31, width=3)
    month1_3_entry = Spinbox(tab1, from_=00, to=12, width=3)
    ...
    date1_3_entry.insert(0,day_phase3.day)
    month1_3_entry.delete(0,"end")
    month1_3_entry.insert(0,day_phase3.month)
    ...
    spin1_A_3 = Spinbox(tab1, from_=00, to=24, width=3)
    spin1_B_3 = Spinbox(tab1, from_=00, to=59, width=3)
    ...
    spin1_C_3 = Spinbox(tab1, from_=00, to=24, width=3)
    spin1_D_3 = Spinbox(tab1, from_=00, to=59, width=3)
    ...
    space1_3_2.grid(column=12,row=2+row_adj,padx=5)
    ...
    spin2_A_1 = Spinbox(tab2, from_=00, to=24, width=3)
    spin2_B_1 = Spinbox(tab2, from_=00, to=59, width=3)
    ...
    spin2_C_1 = Spinbox(tab2, from_=00, to=24, width=3)
    spin2_D_1 = Spinbox(tab2, from_=00, to=59, width=3)
    ...
    rad2_A_1.grid(column=12, row=1+row_adj, padx=15, pady=5)
    lbl2_A_1.grid(column=13, row=1+row_adj, pady=5)
    spin2_A_1.grid(column=14,row=1+row_adj, pady=5)
    label2_h1_1.grid(column=15,row=1+row_adj, pady=5, sticky='w')
    spin2_B_1.grid(column=16,row=1+row_adj, pady=5)
    label2_m1_1.grid(column=17,row=1+row_adj, pady=5, sticky='w')
    lbl2_B_1.grid(column=18, row=1+row_adj, pady=5)
    spin2_C_1.grid(column=19,row=1+row_adj, pady=5)
    label2_h2_1.grid(column=20,row=1+row_adj, pady=5, sticky='w')
    spin2_D_1.grid(column=21,row=1+row_adj, pady=5)
    label2_m2_1.grid(column=22,row=1+row_adj, pady=5, sticky='w')
    rad2_B_1.grid(column=23, row=1+row_adj, padx=15, pady=5)
    rad2_C_1.grid(column=24, row=1+row_adj, pady=5)

        # phase 2
    phaseLabel2_2=Label(tab2, text='Phase 2')
    fromLabel2_2=Label(tab2, text='From:')
    space2_2=Label(tab2, text=" ")
    spin2_E_2 = Spinbox(tab2, from_=00, to=24, width=3)
    spin2_F_2 = Spinbox(tab2, from_=00, to=59, width=3)
    ...
    date2_2_entry = Spinbox(tab2, from_=00, to=31, width=3)
    month2_2_entry = Spinbox(tab2, from_=00, to=12, width=3)
    ...
    spin2_A_2 = Spinbox(tab2, from_=00, to=24, width=3)
    spin2_B_2 = Spinbox(tab2, from_=00, to=59, width=3)
    ...
    spin2_C_2 = Spinbox(tab2, from_=00, to=24, width=3)
    spin2_D_2 = Spinbox(tab2, from_=00, to=59, width=3)
    ...
    rad2_A_2.grid(column=12, row=2+row_adj, padx=15, pady=5)
    lbl2_A_2.grid(column=13, row=2+row_adj, pady=5)
    spin2_A_2.grid(column=14,row=2+row_adj, pady=5)
    label2_h1_2.grid(column=15,row=2+row_adj, pady=5)
    spin2_B_2.grid(column=16,row=2+row_adj, pady=5)
    label2_m1_2.grid(column=17,row=2+row_adj, pady=5)
    lbl2_B_2.grid(column=18, row=2+row_adj, pady=5)
    spin2_C_2.grid(column=19,row=2+row_adj, pady=5)
    label2_h2_2.grid(column=20,row=2+row_adj, pady=5)
    spin2_D_2.grid(column=21,row=2+row_adj, pady=5)
    label2_m2_2.grid(column=22,row=2+row_adj, pady=5)
    rad2_B_2.grid(column=23, row=2+row_adj, padx=15, pady=5)
    rad2_C_2.grid(column=24, row=2+row_adj, pady=5)
        # phase 3
    phaseLabel2_3=Label(tab2, text='Phase 3')
    fromLabel2_3=Label(tab2, text='From:')
    space2_3=Label(tab2, text=" ")
    spin2_E_3 = Spinbox(tab2, from_=00, to=24, width=3)
    spin2_F_3 = Spinbox(tab2, from_=00, to=59, width=3)
    ...
    date2_3_entry = Spinbox(tab2, from_=00, to=31, width=3)
    month2_3_entry = Spinbox(tab2, from_=00, to=12, width=3)
    ...
    spin2_A_3 = Spinbox(tab2, from_=00, to=24, width=3)
    spin2_B_3 = Spinbox(tab2, from_=00, to=59, width=3)
    ...
    spin2_C_3 = Spinbox(tab2, from_=00, to=24, width=3)
    spin2_D_3 = Spinbox(tab2, from_=00, to=59, width=3)
    ...
    rad2_A_3.grid(column=12, row=3+row_adj, padx=15, pady=5)
    lbl2_A_3.grid(column=13, row=3+row_adj, pady=5)
    spin2_A_3.grid(column=14,row=3+row_adj, pady=5)
    label2_h1_3.grid(column=15,row=3+row_adj, pady=5)
    spin2_B_3.grid(column=16,row=3+row_adj, pady=5)
    label2_m1_3.grid(column=17,row=3+row_adj, pady=5)
    lbl2_B_3.grid(column=18, row=3+row_adj, pady=5)
    spin2_C_3.grid(column=19,row=3+row_adj, pady=5)
    label2_h2_3.grid(column=20,row=3+row_adj, pady=5)
    spin2_D_3.grid(column=21,row=3+row_adj, pady=5)
    label2_m2_3.grid(column=22,row=3+row_adj, pady=5)
    rad2_B_3.grid(column=23, row=3+row_adj, padx=15, pady=5)
    rad2_C_3.grid(column=24, row=3+row_adj, pady=5)

    btn2.grid(column=25, row=4+row_adj, padx=25, pady=5)
    ...
    spin3_A_1 = Spinbox(tab3, from_=00, to=24, width=3)
    spin3_B_1 = Spinbox(tab3, from_=00, to=59, width=3)
    ...
    spin3_C_1 = Spinbox(tab3, from_=00, to=24, width=3)
    spin3_D_1 = Spinbox(tab3, from_=00, to=59, width=3)
    ...
    rad3_A_1.grid(column=12, row=1+row_adj, padx=15, pady=5)
    lbl3_A_1.grid(column=13, row=1+row_adj, pady=5)
    spin3_A_1.grid(column=14,row=1+row_adj, pady=5)
    label3_h1_1.grid(column=15,row=1+row_adj, pady=5, sticky='w')
    spin3_B_1.grid(column=16,row=1+row_adj, pady=5)
    label3_m1_1.grid(column=17,row=1+row_adj, pady=5, sticky='w')
    lbl3_B_1.grid(column=18, row=1+row_adj, pady=5)
    spin3_C_1.grid(column=19,row=1+row_adj, pady=5)
    label3_h2_1.grid(column=20,row=1+row_adj, pady=5, sticky='w')
    spin3_D_1.grid(column=21,row=1+row_adj, pady=5)
    label3_m2_1.grid(column=22,row=1+row_adj, pady=5, sticky='w')
    rad3_B_1.grid(column=23, row=1+row_adj, padx=15, pady=5)
    rad3_C_1.grid(column=24, row=1+row_adj, pady=5)

        # phase 2
    phaseLabel3_2=Label(tab3, text='Phase 2')
    fromLabel3_2=Label(tab3, text='From:')
    space3_2=Label(tab3, text=" ")
    spin3_E_2 = Spinbox(tab3, from_=00, to=24, width=3)
    spin3_F_2 = Spinbox(tab3, from_=00, to=59, width=3)
    ...
    date3_2_entry = Spinbox(tab3, from_=00, to=31, width=3)
    month3_2_entry = Spinbox(tab3, from_=00, to=12, width=3)
    ...
    spin3_A_2 = Spinbox(tab3, from_=00, to=24, width=3)
    spin3_B_2 = Spinbox(tab3, from_=00, to=59, width=3)
    ...
    spin3_C_2 = Spinbox(tab3, from_=00, to=24, width=3)
    spin3_D_2 = Spinbox(tab3, from_=00, to=59, width=3)
    ...
    rad3_A_2.grid(column=12, row=2+row_adj, padx=15, pady=5)
    lbl3_A_2.grid(column=13, row=2+row_adj, pady=5)
    spin3_A_2.grid(column=14,row=2+row_adj, pady=5)
    label3_h1_2.grid(column=15,row=2+row_adj, pady=5)
    spin3_B_2.grid(column=16,row=2+row_adj, pady=5)
    label3_m1_2.grid(column=17,row=2+row_adj, pady=5)
    lbl3_B_2.grid(column=18, row=2+row_adj, pady=5)
    spin3_C_2.grid(column=19,row=2+row_adj, pady=5)
    label3_h2_2.grid(column=20,row=2+row_adj, pady=5)
    spin3_D_2.grid(column=21,row=2+row_adj, pady=5)
    label3_m2_2.grid(column=22,row=2+row_adj, pady=5)
    rad3_B_2.grid(column=23, row=2+row_adj, padx=15, pady=5)
    rad3_C_2.grid(column=24, row=2+row_adj, pady=5)
        # phase 3
    phaseLabel3_3=Label(tab3, text='Phase 3')
    fromLabel3_3=Label(tab3, text='From:')
    space3_3=Label(tab3, text=" ")
    spin3_E_3 = Spinbox(tab3, from_=00, to=24, width=3)
    spin3_F_3 = Spinbox(tab3, from_=00, to=59, width=3)
    ...
    date3_3_entry = Spinbox(tab3, from_=00, to=31, width=3)
    month3_3_entry = Spinbox(tab3, from_=00, to=12, width=3)
    ...
    spin3_A_3 = Spinbox(tab3, from_=00, to=24, width=3)
    spin3_B_3 = Spinbox(tab3, from_=00, to=59, width=3)
    ...
    spin3_C_3 = Spinbox(tab3, from_=00, to=24, width=3)
    spin3_D_3 = Spinbox(tab3, from_=00, to=59, width=3)
    ...
    rad3_A_3.grid(column=12, row=3+row_adj, padx=15, pady=5)
    lbl3_A_3.grid(column=13, row=3+row_adj, pady=5)
    spin3_A_3.grid(column=14,row=3+row_adj, pady=5)
    label3_h1_3.grid(column=15,row=3+row_adj, pady=5)
    spin3_B_3.grid(column=16,row=3+row_adj, pady=5)
    label3_m1_3.grid(column=17,row=3+row_adj, pady=5)
    lbl3_B_3.grid(column=18, row=3+row_adj, pady=5)
    spin3_C_3.grid(column=19,row=3+row_adj, pady=5)
    label3_h2_3.grid(column=20,row=3+row_adj, pady=5)
    spin3_D_3.grid(column=21,row=3+row_adj, pady=5)
    label3_m2_3.grid(column=22,row=3+row_adj, pady=5)
    rad3_B_3.grid(column=23, row=3+row_adj, padx=15, pady=5)
    rad3_C_3.grid(column=24, row=3+row_adj, pady=5)

    btn3.grid(column=25, row=4+row_adj, padx=25, pady=5)
    ...
    spin4_A_1 = Spinbox(tab4, from_=00, to=24, width=3)
    spin4_B_1 = Spinbox(tab4, from_=00, to=59, width=3)
    ...
    spin4_C_1 = Spinbox(tab4, from_=00, to=24, width=3)
    spin4_D_1 = Spinbox(tab4, from_=00, to=59, width=3)
    ...
    rad4_A_1.grid(column=12, row=1+row_adj, padx=15, pady=5)
    lbl4_A_1.grid(column=13, row=1+row_adj, pady=5)
    spin4_A_1.grid(column=14,row=1+row_adj, pady=5)
    label4_h1_1.grid(column=15,row=1+row_adj, pady=5, sticky='w')
    spin4_B_1.grid(column=16,row=1+row_adj, pady=5)
    label4_m1_1.grid(column=17,row=1+row_adj, pady=5, sticky='w')
    lbl4_B_1.grid(column=18, row=1+row_adj, pady=5)
    spin4_C_1.grid(column=19,row=1+row_adj, pady=5)
    label4_h2_1.grid(column=20,row=1+row_adj, pady=5, sticky='w')
    spin4_D_1.grid(column=21,row=1+row_adj, pady=5)
    label4_m2_1.grid(column=22,row=1+row_adj, pady=5, sticky='w')
    rad4_B_1.grid(column=23, row=1+row_adj, padx=15, pady=5)
    rad4_C_1.grid(column=24, row=1+row_adj, pady=5)

        # phase 2
    phaseLabel4_2=Label(tab4, text='Phase 2')
    fromLabel4_2=Label(tab4, text='From:')
    space4_2=Label(tab4, text=" ")
    spin4_E_2 = Spinbox(tab4, from_=00, to=24, width=3)
    spin4_F_2 = Spinbox(tab4, from_=00, to=59, width=3)
    ...
    date4_2_entry = Spinbox(tab4, from_=00, to=31, width=3)
    month4_2_entry = Spinbox(tab4, from_=00, to=12, width=3)
    ...
    spin4_A_2 = Spinbox(tab4, from_=00, to=24, width=3)
    spin4_B_2 = Spinbox(tab4, from_=00, to=59, width=3)
    ...
    spin4_C_2 = Spinbox(tab4, from_=00, to=24, width=3)
    spin4_D_2 = Spinbox(tab4, from_=00, to=59, width=3)
    ...
    year4_2_entry.grid(column=7, row=2+row_adj)
    rad4_A_2.grid(column=12, row=2+row_adj, padx=15, pady=5)
    lbl4_A_2.grid(column=13, row=2+row_adj, pady=5)
    spin4_A_2.grid(column=14,row=2+row_adj, pady=5)
    label4_h1_2.grid(column=15,row=2+row_adj, pady=5)
    spin4_B_2.grid(column=16,row=2+row_adj, pady=5)
    label4_m1_2.grid(column=17,row=2+row_adj, pady=5)
    lbl4_B_2.grid(column=18, row=2+row_adj, pady=5)
    spin4_C_2.grid(column=19,row=2+row_adj, pady=5)
    label4_h2_2.grid(column=20,row=2+row_adj, pady=5)
    spin4_D_2.grid(column=21,row=2+row_adj, pady=5)
    label4_m2_2.grid(column=22,row=2+row_adj, pady=5)
    rad4_B_2.grid(column=23, row=2+row_adj, padx=15, pady=5)
    rad4_C_2.grid(column=24, row=2+row_adj, pady=5)
        # phase 3
    phaseLabel4_3=Label(tab4, text='Phase 3')
    fromLabel4_3=Label(tab4, text='From:')
    space4_3=Label(tab4, text=" ")
    spin4_E_3 = Spinbox(tab4, from_=00, to=24, width=3)
    spin4_F_3 = Spinbox(tab4, from_=00, to=59, width=3)
    ...
    date4_3_entry = Spinbox(tab4, from_=00, to=31, width=3)
    month4_3_entry = Spinbox(tab4, from_=00, to=12, width=3)
    ...
    spin4_A_3 = Spinbox(tab4, from_=00, to=24, width=3)
    spin4_B_3 = Spinbox(tab4, from_=00, to=59, width=3)
    ...
    spin4_C_3 = Spinbox(tab4, from_=00, to=24, width=3)
    spin4_D_3 = Spinbox(tab4, from_=00, to=59, width=3)
    ...
    rad4_A_3.grid(column=12, row=3+row_adj, padx=15, pady=5)
    lbl4_A_3.grid(column=13, row=3+row_adj, pady=5)
    spin4_A_3.grid(column=14,row=3+row_adj, pady=5)
    label4_h1_3.grid(column=15,row=3+row_adj, pady=5)
    spin4_B_3.grid(column=16,row=3+row_adj, pady=5)
    label4_m1_3.grid(column=17,row=3+row_adj, pady=5)
    lbl4_B_3.grid(column=18, row=3+row_adj, pady=5)
    spin4_C_3.grid(column=19,row=3+row_adj, pady=5)
    label4_h2_3.grid(column=20,row=3+row_adj, pady=5)
    spin4_D_3.grid(column=21,row=3+row_adj, pady=5)
    label4_m2_3.grid(column=22,row=3+row_adj, pady=5)
    rad4_B_3.grid(column=23, row=3+row_adj, padx=15, pady=5)
    rad4_C_3.grid(column=24, row=3+row_adj, pady=5)

    btn4.grid(column=25, row=4+row_adj, padx=25, pady=5)
    ...
    spin5_A_1 = Spinbox(tab5, from_=00, to=24, width=3)
    spin5_B_1 = Spinbox(tab5, from_=00, to=59, width=3)
    ...
    spin5_C_1 = Spinbox(tab5, from_=00, to=24, width=3)
    spin5_D_1 = Spinbox(tab5, from_=00, to=59, width=3)
    ...
    rad5_A_1.grid(column=12, row=1+row_adj, padx=15, pady=5)
    lbl5_A_1.grid(column=13, row=1+row_adj, pady=5)
    spin5_A_1.grid(column=14,row=1+row_adj, pady=5)
    label5_h1_1.grid(column=15,row=1+row_adj, pady=5, sticky='w')
    spin5_B_1.grid(column=16,row=1+row_adj, pady=5)
    label5_m1_1.grid(column=17,row=1+row_adj, pady=5, sticky='w')
    lbl5_B_1.grid(column=18, row=1+row_adj, pady=5)
    spin5_C_1.grid(column=19,row=1+row_adj, pady=5)
    label5_h2_1.grid(column=20,row=1+row_adj, pady=5, sticky='w')
    spin5_D_1.grid(column=21,row=1+row_adj, pady=5)
    label5_m2_1.grid(column=22,row=1+row_adj, pady=5, sticky='w')
    rad5_B_1.grid(column=23, row=1+row_adj, padx=15, pady=5)
    rad5_C_1.grid(column=24, row=1+row_adj, pady=5)

        # phase 2
    phaseLabel5_2=Label(tab5, text='Phase 2')
    fromLabel5_2=Label(tab5, text='From:')
    space5_2=Label(tab5, text=" ")
    spin5_E_2 = Spinbox(tab5, from_=00, to=24, width=3)
    spin5_F_2 = Spinbox(tab5, from_=00, to=59, width=3)
    ...
    date5_2_entry = Spinbox(tab5, from_=00, to=31, width=3)
    month5_2_entry = Spinbox(tab5, from_=00, to=12, width=3)
    ...
    spin5_A_2 = Spinbox(tab5, from_=00, to=24, width=3)
    spin5_B_2 = Spinbox(tab5, from_=00, to=59, width=3)
    ...
    spin5_C_2 = Spinbox(tab5, from_=00, to=24, width=3)
    spin5_D_2 = Spinbox(tab5, from_=00, to=59, width=3)
    ...
    rad5_A_2.grid(column=12, row=2+row_adj, padx=15, pady=5)
    lbl5_A_2.grid(column=13, row=2+row_adj, pady=5)
    spin5_A_2.grid(column=14,row=2+row_adj, pady=5)
    label5_h1_2.grid(column=15,row=2+row_adj, pady=5)
    spin5_B_2.grid(column=16,row=2+row_adj, pady=5)
    label5_m1_2.grid(column=17,row=2+row_adj, pady=5)
    lbl5_B_2.grid(column=18, row=2+row_adj, pady=5)
    spin5_C_2.grid(column=19,row=2+row_adj, pady=5)
    label5_h2_2.grid(column=20,row=2+row_adj, pady=5)
    spin5_D_2.grid(column=21,row=2+row_adj, pady=5)
    label5_m2_2.grid(column=22,row=2+row_adj, pady=5)
    rad5_B_2.grid(column=23, row=2+row_adj, padx=15, pady=5)
    rad5_C_2.grid(column=24, row=2+row_adj, pady=5)
        # phase 3
    phaseLabel5_3=Label(tab5, text='Phase 3')
    fromLabel5_3=Label(tab5, text='From:')
    space5_3=Label(tab5, text=" ")
    spin5_E_3 = Spinbox(tab5, from_=00, to=24, width=3)
    spin5_F_3 = Spinbox(tab5, from_=00, to=59, width=3)
    ...
    date5_3_entry = Spinbox(tab5, from_=00, to=31, width=3)
    month5_3_entry = Spinbox(tab5, from_=00, to=12, width=3)
    ...
    spin5_A_3 = Spinbox(tab5, from_=00, to=24, width=3)
    spin5_B_3 = Spinbox(tab5, from_=00, to=59, width=3)
    ...
    spin5_C_3 = Spinbox(tab5, from_=00, to=24, width=3)
    spin5_D_3 = Spinbox(tab5, from_=00, to=59, width=3)
    ...
    rad5_A_3.grid(column=12, row=3+row_adj, padx=15, pady=5)
    lbl5_A_3.grid(column=13, row=3+row_adj, pady=5)
    spin5_A_3.grid(column=14,row=3+row_adj, pady=5)
    label5_h1_3.grid(column=15,row=3+row_adj, pady=5)
    spin5_B_3.grid(column=16,row=3+row_adj, pady=5)
    label5_m1_3.grid(column=17,row=3+row_adj, pady=5)
    lbl5_B_3.grid(column=18, row=3+row_adj, pady=5)
    spin5_C_3.grid(column=19,row=3+row_adj, pady=5)
    label5_h2_3.grid(column=20,row=3+row_adj, pady=5)
    spin5_D_3.grid(column=21,row=3+row_adj, pady=5)
    label5_m2_3.grid(column=22,row=3+row_adj, pady=5)
    rad5_B_3.grid(column=23, row=3+row_adj, padx=15, pady=5)
    rad5_C_3.grid(column=24, row=3+row_adj, pady=5)

    btn5.grid(column=25, row=4+row_adj, padx=25, pady=5)
    ...
    spin6_A_1 = Spinbox(tab6, from_=00, to=24, width=3)
    spin6_B_1 = Spinbox(tab6, from_=00, to=59, width=3)
    ...
    spin6_C_1 = Spinbox(tab6, from_=00, to=24, width=3)
    spin6_D_1 = Spinbox(tab6, from_=00, to=59, width=3)
    ...
    rad6_A_1.grid(column=12, row=1+row_adj, padx=15, pady=5)
    lbl6_A_1.grid(column=13, row=1+row_adj, pady=5)
    spin6_A_1.grid(column=14,row=1+row_adj, pady=5)
    label6_h1_1.grid(column=15,row=1+row_adj, pady=5, sticky='w')
    spin6_B_1.grid(column=16,row=1+row_adj, pady=5)
    label6_m1_1.grid(column=17,row=1+row_adj, pady=5, sticky='w')
    lbl6_B_1.grid(column=18, row=1+row_adj, pady=5)
    spin6_C_1.grid(column=19,row=1+row_adj, pady=5)
    label6_h2_1.grid(column=20,row=1+row_adj, pady=5, sticky='w')
    spin6_D_1.grid(column=21,row=1+row_adj, pady=5)
    label6_m2_1.grid(column=22,row=1+row_adj, pady=5, sticky='w')
    rad6_B_1.grid(column=23, row=1+row_adj, padx=15, pady=5)
    rad6_C_1.grid(column=24, row=1+row_adj, pady=5)

        # phase 2
    phaseLabel6_2=Label(tab6, text='Phase 2')
    fromLabel6_2=Label(tab6, text='From:')
    space6_2=Label(tab6, text=" ")
    spin6_E_2 = Spinbox(tab6, from_=00, to=24, width=3)
    spin6_F_2 = Spinbox(tab6, from_=00, to=59, width=3)
    ...
    date6_2_entry = Spinbox(tab6, from_=00, to=31, width=3)
    month6_2_entry = Spinbox(tab6, from_=00, to=12, width=3)
    ...
    spin6_A_2 = Spinbox(tab6, from_=00, to=24, width=3)
    spin6_B_2 = Spinbox(tab6, from_=00, to=59, width=3)
    ...
    spin6_C_2 = Spinbox(tab6, from_=00, to=24, width=3)
    spin6_D_2 = Spinbox(tab6, from_=00, to=59, width=3)
    ...
    rad6_A_2.grid(column=12, row=2+row_adj, padx=15, pady=5)
    lbl6_A_2.grid(column=13, row=2+row_adj, pady=5)
    spin6_A_2.grid(column=14,row=2+row_adj, pady=5)
    label6_h1_2.grid(column=15,row=2+row_adj, pady=5)
    spin6_B_2.grid(column=16,row=2+row_adj, pady=5)
    label6_m1_2.grid(column=17,row=2+row_adj, pady=5)
    lbl6_B_2.grid(column=18, row=2+row_adj, pady=5)
    spin6_C_2.grid(column=19,row=2+row_adj, pady=5)
    label6_h2_2.grid(column=20,row=2+row_adj, pady=5)
    spin6_D_2.grid(column=21,row=2+row_adj, pady=5)
    label6_m2_2.grid(column=22,row=2+row_adj, pady=5)
    rad6_B_2.grid(column=23, row=2+row_adj, padx=15, pady=5)
    rad6_C_2.grid(column=24, row=2+row_adj, pady=5)
        # phase 3
    phaseLabel6_3=Label(tab6, text='Phase 3')
    fromLabel6_3=Label(tab6, text='From:')
    space6_3=Label(tab6, text=" ")
    spin6_E_3 = Spinbox(tab6, from_=00, to=24, width=3)
    spin6_F_3 = Spinbox(tab6, from_=00, to=59, width=3)
    ...
    date6_3_entry = Spinbox(tab6, from_=00, to=31, width=3)
    month6_3_entry = Spinbox(tab6, from_=00, to=12, width=3)
    ...
    spin6_A_3 = Spinbox(tab6, from_=00, to=24, width=3)
    spin6_B_3 = Spinbox(tab6, from_=00, to=59, width=3)
    ...
    spin6_C_3 = Spinbox(tab6, from_=00, to=24, width=3)
    spin6_D_3 = Spinbox(tab6, from_=00, to=59, width=3)
    ...
    rad6_A_3.grid(column=12, row=3+row_adj, padx=15, pady=5)
    lbl6_A_3.grid(column=13, row=3+row_adj, pady=5)
    spin6_A_3.grid(column=14,row=3+row_adj, pady=5)
    label6_h1_3.grid(column=15,row=3+row_adj, pady=5)
    spin6_B_3.grid(column=16,row=3+row_adj, pady=5)
    label6_m1_3.grid(column=17,row=3+row_adj, pady=5)
    lbl6_B_3.grid(column=18, row=3+row_adj, pady=5)
    spin6_C_3.grid(column=19,row=3+row_adj, pady=5)
    label6_h2_3.grid(column=20,row=3+row_adj, pady=5)
    spin6_D_3.grid(column=21,row=3+row_adj, pady=5)
    label6_m2_3.grid(column=22,row=3+row_adj, pady=5)
    rad6_B_3.grid(column=23, row=3+row_adj, padx=15, pady=5)
    rad6_C_3.grid(column=24, row=3+row_adj, pady=5)

    btn6.grid(column=25, row=4+row_adj, padx=25, pady=5)
    ...
    spin7_A_1 = Spinbox(tab7, from_=00, to=24, width=3)
    spin7_B_1 = Spinbox(tab7, from_=00, to=59, width=3)
    ...
    spin7_C_1 = Spinbox(tab7, from_=00, to=24, width=3)
    spin7_D_1 = Spinbox(tab7, from_=00, to=59, width=3)
    ...
    rad7_A_1.grid(column=12, row=1+row_adj, padx=15, pady=5)
    lbl7_A_1.grid(column=13, row=1+row_adj, pady=5)
    spin7_A_1.grid(column=14,row=1+row_adj, pady=5)
    label7_h1_1.grid(column=15,row=1+row_adj, pady=5, sticky='w')
    spin7_B_1.grid(column=16,row=1+row_adj, pady=5)
    label7_m1_1.grid(column=17,row=1+row_adj, pady=5, sticky='w')
    lbl7_B_1.grid(column=18, row=1+row_adj, pady=5)
    spin7_C_1.grid(column=19,row=1+row_adj, pady=5)
    label7_h2_1.grid(column=20,row=1+row_adj, pady=5, sticky='w')
    spin7_D_1.grid(column=21,row=1+row_adj, pady=5)
    label7_m2_1.grid(column=22,row=1+row_adj, pady=5, sticky='w')
    rad7_B_1.grid(column=23, row=1+row_adj, padx=15, pady=5)
    rad7_C_1.grid(column=24, row=1+row_adj, pady=5)

        # phase 2
    phaseLabel7_2=Label(tab7, text='Phase 2')
    fromLabel7_2=Label(tab7, text='From:')
    space7_2=Label(tab7, text=" ")
    spin7_E_2 = Spinbox(tab7, from_=00, to=24, width=3)
    spin7_F_2 = Spinbox(tab7, from_=00, to=59, width=3)
    ...
    date7_2_entry = Spinbox(tab7, from_=00, to=31, width=3)
    month7_2_entry = Spinbox(tab7, from_=00, to=12, width=3)
    ...
    spin7_A_2 = Spinbox(tab7, from_=00, to=24, width=3)
    spin7_B_2 = Spinbox(tab7, from_=00, to=59, width=3)
    ...
    spin7_C_2 = Spinbox(tab7, from_=00, to=24, width=3)
    spin7_D_2 = Spinbox(tab7, from_=00, to=59, width=3)
    ...
    rad7_A_2.grid(column=12, row=2+row_adj, padx=15, pady=5)
    lbl7_A_2.grid(column=13, row=2+row_adj, pady=5)
    spin7_A_2.grid(column=14,row=2+row_adj, pady=5)
    label7_h1_2.grid(column=15,row=2+row_adj, pady=5)
    spin7_B_2.grid(column=16,row=2+row_adj, pady=5)
    label7_m1_2.grid(column=17,row=2+row_adj, pady=5)
    lbl7_B_2.grid(column=18, row=2+row_adj, pady=5)
    spin7_C_2.grid(column=19,row=2+row_adj, pady=5)
    label7_h2_2.grid(column=20,row=2+row_adj, pady=5)
    spin7_D_2.grid(column=21,row=2+row_adj, pady=5)
    label7_m2_2.grid(column=22,row=2+row_adj, pady=5)
    rad7_B_2.grid(column=23, row=2+row_adj, padx=15, pady=5)
    rad7_C_2.grid(column=24, row=2+row_adj, pady=5)
        # phase 3
    phaseLabel7_3=Label(tab7, text='Phase 3')
    fromLabel7_3=Label(tab7, text='From:')
    space7_3=Label(tab7, text=" ")
    spin7_E_3 = Spinbox(tab7, from_=00, to=24, width=3)
    spin7_F_3 = Spinbox(tab7, from_=00, to=59, width=3)
    ...
    date7_3_entry = Spinbox(tab7, from_=00, to=31, width=3)
    month7_3_entry = Spinbox(tab7, from_=00, to=12, width=3)
    ...
    spin7_A_3 = Spinbox(tab7, from_=00, to=24, width=3)
    spin7_B_3 = Spinbox(tab7, from_=00, to=59, width=3)
    ...
    spin7_C_3 = Spinbox(tab7, from_=00, to=24, width=3)
    spin7_D_3 = Spinbox(tab7, from_=00, to=59, width=3)
    ...
    rad7_A_3.grid(column=12, row=3+row_adj, padx=15, pady=5)
    lbl7_A_3.grid(column=13, row=3+row_adj, pady=5)
    spin7_A_3.grid(column=14,row=3+row_adj, pady=5)
    label7_h1_3.grid(column=15,row=3+row_adj, pady=5)
    spin7_B_3.grid(column=16,row=3+row_adj, pady=5)
    label7_m1_3.grid(column=17,row=3+row_adj, pady=5)
    lbl7_B_3.grid(column=18, row=3+row_adj, pady=5)
    spin7_C_3.grid(column=19,row=3+row_adj, pady=5)
    label7_h2_3.grid(column=20,row=3+row_adj, pady=5)
    spin7_D_3.grid(column=21,row=3+row_adj, pady=5)
    label7_m2_3.grid(column=22,row=3+row_adj, pady=5)
    rad7_B_3.grid(column=23, row=3+row_adj, padx=15, pady=5)
    rad7_C_3.grid(column=24, row=3+row_adj, pady=5)

    btn7.grid(column=25, row=4+row_adj, padx=25, pady=5)
    ...
    spin8_A_1 = Spinbox(tab8, from_=00, to=24, width=3)
    spin8_B_1 = Spinbox(tab8, from_=00, to=59, width=3)
    ...
    spin8_C_1 = Spinbox(tab8, from_=00, to=24, width=3)
    spin8_D_1 = Spinbox(tab8, from_=00, to=59, width=3)
    ...
    rad8_A_1.grid(column=12, row=1+row_adj, padx=15, pady=5)
    lbl8_A_1.grid(column=13, row=1+row_adj, pady=5)
    spin8_A_1.grid(column=14,row=1+row_adj, pady=5)
    label8_h1_1.grid(column=15,row=1+row_adj, pady=5, sticky='w')
    spin8_B_1.grid(column=16,row=1+row_adj, pady=5)
    label8_m1_1.grid(column=17,row=1+row_adj, pady=5, sticky='w')
    lbl8_B_1.grid(column=18, row=1+row_adj, pady=5)
    spin8_C_1.grid(column=19,row=1+row_adj, pady=5)
    label8_h2_1.grid(column=20,row=1+row_adj, pady=5, sticky='w')
    spin8_D_1.grid(column=21,row=1+row_adj, pady=5)
    label8_m2_1.grid(column=22,row=1+row_adj, pady=5, sticky='w')
    rad8_B_1.grid(column=23, row=1+row_adj, padx=15, pady=5)
    rad8_C_1.grid(column=24, row=1+row_adj, pady=5)

        # phase 2
    phaseLabel8_2=Label(tab8, text='Phase 2')
    fromLabel8_2=Label(tab8, text='From:')
    space8_2=Label(tab8, text=" ")
    spin8_E_2 = Spinbox(tab8, from_=00, to=24, width=3)
    spin8_F_2 = Spinbox(tab8, from_=00, to=59, width=3)
    ...
    date8_2_entry = Spinbox(tab8, from_=00, to=31, width=3)
    month8_2_entry = Spinbox(tab8, from_=00, to=12, width=3)
    ...
    spin8_A_2 = Spinbox(tab8, from_=00, to=24, width=3)
    spin8_B_2 = Spinbox(tab8, from_=00, to=59, width=3)
    ...
    spin8_C_2 = Spinbox(tab8, from_=00, to=24, width=3)
    spin8_D_2 = Spinbox(tab8, from_=00, to=59, width=3)
    ...
    rad8_A_2.grid(column=12, row=2+row_adj, padx=15, pady=5)
    lbl8_A_2.grid(column=13, row=2+row_adj, pady=5)
    spin8_A_2.grid(column=14,row=2+row_adj, pady=5)
    label8_h1_2.grid(column=15,row=2+row_adj, pady=5)
    spin8_B_2.grid(column=16,row=2+row_adj, pady=5)
    label8_m1_2.grid(column=17,row=2+row_adj, pady=5)
    lbl8_B_2.grid(column=18, row=2+row_adj, pady=5)
    spin8_C_2.grid(column=19,row=2+row_adj, pady=5)
    label8_h2_2.grid(column=20,row=2+row_adj, pady=5)
    spin8_D_2.grid(column=21,row=2+row_adj, pady=5)
    label8_m2_2.grid(column=22,row=2+row_adj, pady=5)
    rad8_B_2.grid(column=23, row=2+row_adj, padx=15, pady=5)
    rad8_C_2.grid(column=24, row=2+row_adj, pady=5)
        # phase 3
    phaseLabel8_3=Label(tab8, text='Phase 3')
    fromLabel8_3=Label(tab8, text='From:')
    space8_3=Label(tab8, text=" ")
    spin8_E_3 = Spinbox(tab8, from_=00, to=24, width=3)
    spin8_F_3 = Spinbox(tab8, from_=00, to=59, width=3)
    ...
    date8_3_entry = Spinbox(tab8, from_=00, to=31, width=3)
    month8_3_entry = Spinbox(tab8, from_=00, to=12, width=3)
    ...
    spin8_A_3 = Spinbox(tab8, from_=00, to=24, width=3)
    spin8_B_3 = Spinbox(tab8, from_=00, to=59, width=3)
    ...
    spin8_C_3 = Spinbox(tab8, from_=00, to=24, width=3)
    spin8_D_3 = Spinbox(tab8, from_=00, to=59, width=3)
    ...
    rad8_A_3.grid(column=12, row=3+row_adj, padx=15, pady=5)
    lbl8_A_3.grid(column=13, row=3+row_adj, pady=5)
    spin8_A_3.grid(column=14,row=3+row_adj, pady=5)
    label8_h1_3.grid(column=15,row=3+row_adj, pady=5)
    spin8_B_3.grid(column=16,row=3+row_adj, pady=5)
    label8_m1_3.grid(column=17,row=3+row_adj, pady=5)
    lbl8_B_3.grid(column=18, row=3+row_adj, pady=5)
    spin8_C_3.grid(column=19,row=3+row_adj, pady=5)
    label8_h2_3.grid(column=20,row=3+row_adj, pady=5)
    spin8_D_3.grid(column=21,row=3+row_adj, pady=5)
    label8_m2_3.grid(column=22,row=3+row_adj, pady=5)
    rad8_B_3.grid(column=23, row=3+row_adj, padx=15, pady=5)
    rad8_C_3.grid(column=24, row=3+row_adj, pady=5)

    btn8.grid(column=25, row=4+row_adj, padx=25, pady=5)
    ...
    spin9_A_1 = Spinbox(tab9, from_=00, to=24, width=3)
    spin9_B_1 = Spinbox(tab9, from_=00, to=59, width=3)
    ...
    spin9_C_1 = Spinbox(tab9, from_=00, to=24, width=3)
    spin9_D_1 = Spinbox(tab9, from_=00, to=59, width=3)
    ...
    rad9_A_1.grid(column=12, row=1+row_adj, padx=15, pady=5)
    lbl9_A_1.grid(column=13, row=1+row_adj, pady=5)
    spin9_A_1.grid(column=14,row=1+row_adj, pady=5)
    label9_h1_1.grid(column=15,row=1+row_adj, pady=5, sticky='w')
    spin9_B_1.grid(column=16,row=1+row_adj, pady=5)
    label9_m1_1.grid(column=17,row=1+row_adj, pady=5, sticky='w')
    lbl9_B_1.grid(column=18, row=1+row_adj, pady=5)
    spin9_C_1.grid(column=19,row=1+row_adj, pady=5)
    label9_h2_1.grid(column=20,row=1+row_adj, pady=5, sticky='w')
    spin9_D_1.grid(column=21,row=1+row_adj, pady=5)
    label9_m2_1.grid(column=22,row=1+row_adj, pady=5, sticky='w')
    rad9_B_1.grid(column=23, row=1+row_adj, padx=15, pady=5)
    rad9_C_1.grid(column=24, row=1+row_adj, pady=5)

        # phase 2
    phaseLabel9_2=Label(tab9, text='Phase 2')
    fromLabel9_2=Label(tab9, text='From:')
    space9_2=Label(tab9, text=" ")
    spin9_E_2 = Spinbox(tab9, from_=00, to=24, width=3)
    spin9_F_2 = Spinbox(tab9, from_=00, to=59, width=3)
    ...
    date9_2_entry = Spinbox(tab9, from_=00, to=31, width=3)
    month9_2_entry = Spinbox(tab9, from_=00, to=12, width=3)
    ...
    spin9_A_2 = Spinbox(tab9, from_=00, to=24, width=3)
    spin9_B_2 = Spinbox(tab9, from_=00, to=59, width=3)
    ...
    spin9_C_2 = Spinbox(tab9, from_=00, to=24, width=3)
    spin9_D_2 = Spinbox(tab9, from_=00, to=59, width=3)
    ...
    rad9_A_2.grid(column=12, row=2+row_adj, padx=15, pady=5)
    lbl9_A_2.grid(column=13, row=2+row_adj, pady=5)
    spin9_A_2.grid(column=14,row=2+row_adj, pady=5)
    label9_h1_2.grid(column=15,row=2+row_adj, pady=5)
    spin9_B_2.grid(column=16,row=2+row_adj, pady=5)
    label9_m1_2.grid(column=17,row=2+row_adj, pady=5)
    lbl9_B_2.grid(column=18, row=2+row_adj, pady=5)
    spin9_C_2.grid(column=19,row=2+row_adj, pady=5)
    label9_h2_2.grid(column=20,row=2+row_adj, pady=5)
    spin9_D_2.grid(column=21,row=2+row_adj, pady=5)
    label9_m2_2.grid(column=22,row=2+row_adj, pady=5)
    rad9_B_2.grid(column=23, row=2+row_adj, padx=15, pady=5)
    rad9_C_2.grid(column=24, row=2+row_adj, pady=5)
        # phase 3
    phaseLabel9_3=Label(tab9, text='Phase 3')
    fromLabel9_3=Label(tab9, text='From:')
    space9_3=Label(tab9, text=" ")
    spin9_E_3 = Spinbox(tab9, from_=00, to=24, width=3)
    spin9_F_3 = Spinbox(tab9, from_=00, to=59, width=3)
    ...
    date9_3_entry = Spinbox(tab9, from_=00, to=31, width=3)
    month9_3_entry = Spinbox(tab9, from_=00, to=12, width=3)
    ...
    spin9_A_3 = Spinbox(tab9, from_=00, to=24, width=3)
    spin9_B_3 = Spinbox(tab9, from_=00, to=59, width=3)
    ...
    spin9_C_3 = Spinbox(tab9, from_=00, to=24, width=3)
    spin9_D_3 = Spinbox(tab9, from_=00, to=59, width=3)
    ...
    rad9_A_3.grid(column=12, row=3+row_adj, padx=15, pady=5)
    lbl9_A_3.grid(column=13, row=3+row_adj, pady=5)
    spin9_A_3.grid(column=14,row=3+row_adj, pady=5)
    label9_h1_3.grid(column=15,row=3+row_adj, pady=5)
    spin9_B_3.grid(column=16,row=3+row_adj, pady=5)
    label9_m1_3.grid(column=17,row=3+row_adj, pady=5)
    lbl9_B_3.grid(column=18, row=3+row_adj, pady=5)
    spin9_C_3.grid(column=19,row=3+row_adj, pady=5)
    label9_h2_3.grid(column=20,row=3+row_adj, pady=5)
    spin9_D_3.grid(column=21,row=3+row_adj, pady=5)
    label9_m2_3.grid(column=22,row=3+row_adj, pady=5)
    rad9_B_3.grid(column=23, row=3+row_adj, padx=15, pady=5)
    rad9_C_3.grid(column=24, row=3+row_adj, pady=5)

    btn9.grid(column=25, row=4+row_adj, padx=25, pady=5)
    ...
    spin10_A_1 = Spinbox(tab10, from_=00, to=24, width=3)
    spin10_B_1 = Spinbox(tab10, from_=00, to=59, width=3)
    ...
    spin10_C_1 = Spinbox(tab10, from_=00, to=24, width=3)
    spin10_D_1 = Spinbox(tab10, from_=00, to=59, width=3)
    ...
    rad10_A_1.grid(column=12, row=1+row_adj, padx=15, pady=5)
    lbl10_A_1.grid(column=13, row=1+row_adj, pady=5)
    spin10_A_1.grid(column=14,row=1+row_adj, pady=5)
    label10_h1_1.grid(column=15,row=1+row_adj, pady=5, sticky='w')
    spin10_B_1.grid(column=16,row=1+row_adj, pady=5)
    label10_m1_1.grid(column=17,row=1+row_adj, pady=5, sticky='w')
    lbl10_B_1.grid(column=18, row=1+row_adj, pady=5)
    spin10_C_1.grid(column=19,row=1+row_adj, pady=5)
    label10_h2_1.grid(column=20,row=1+row_adj, pady=5, sticky='w')
    spin10_D_1.grid(column=21,row=1+row_adj, pady=5)
    label10_m2_1.grid(column=22,row=1+row_adj, pady=5, sticky='w')
    rad10_B_1.grid(column=23, row=1+row_adj, padx=15, pady=5)
    rad10_C_1.grid(column=24, row=1+row_adj, pady=5)

        # phase 2
    phaseLabel10_2=Label(tab10, text='Phase 2')
    fromLabel10_2=Label(tab10, text='From:')
    space10_2=Label(tab10, text=" ")
    spin10_E_2 = Spinbox(tab10, from_=00, to=24, width=3)
    spin10_F_2 = Spinbox(tab10, from_=00, to=59, width=3)
    ...
    date10_2_entry = Spinbox(tab10, from_=00, to=31, width=3)
    month10_2_entry = Spinbox(tab10, from_=00, to=12, width=3)
    ...
    spin10_A_2 = Spinbox(tab10, from_=00, to=24, width=3)
    spin10_B_2 = Spinbox(tab10, from_=00, to=59, width=3)
    ...
    spin10_C_2 = Spinbox(tab10, from_=00, to=24, width=3)
    spin10_D_2 = Spinbox(tab10, from_=00, to=59, width=3)
    ...
    rad10_A_2.grid(column=12, row=2+row_adj, padx=15, pady=5)
    lbl10_A_2.grid(column=13, row=2+row_adj, pady=5)
    spin10_A_2.grid(column=14,row=2+row_adj, pady=5)
    label10_h1_2.grid(column=15,row=2+row_adj, pady=5)
    spin10_B_2.grid(column=16,row=2+row_adj, pady=5)
    label10_m1_2.grid(column=17,row=2+row_adj, pady=5)
    lbl10_B_2.grid(column=18, row=2+row_adj, pady=5)
    spin10_C_2.grid(column=19,row=2+row_adj, pady=5)
    label10_h2_2.grid(column=20,row=2+row_adj, pady=5)
    spin10_D_2.grid(column=21,row=2+row_adj, pady=5)
    label10_m2_2.grid(column=22,row=2+row_adj, pady=5)
    rad10_B_2.grid(column=23, row=2+row_adj, padx=15, pady=5)
    rad10_C_2.grid(column=24, row=2+row_adj, pady=5)
        # phase 3
    phaseLabel10_3=Label(tab10, text='Phase 3')
    fromLabel10_3=Label(tab10, text='From:')
    space10_3=Label(tab10, text=" ")
    spin10_E_3 = Spinbox(tab10, from_=00, to=24, width=3)
    spin10_F_3 = Spinbox(tab10, from_=00, to=59, width=3)
    ...
    date10_3_entry = Spinbox(tab10, from_=00, to=31, width=3)
    month10_3_entry = Spinbox(tab10, from_=00, to=12, width=3)
    ...
    spin10_A_3 = Spinbox(tab10, from_=00, to=24, width=3)
    spin10_B_3 = Spinbox(tab10, from_=00, to=59, width=3)
    ...
    spin10_C_3 = Spinbox(tab10, from_=00, to=24, width=3)
    spin10_D_3 = Spinbox(tab10, from_=00, to=59, width=3)
    ...
    rad10_A_3.grid(column=12, row=3+row_adj, padx=15, pady=5)
    lbl10_A_3.grid(column=13, row=3+row_adj, pady=5)
    spin10_A_3.grid(column=14,row=3+row_adj, pady=5)
    label10_h1_3.grid(column=15,row=3+row_adj, pady=5)
    spin10_B_3.grid(column=16,row=3+row_adj, pady=5)
    label10_m1_3.grid(column=17,row=3+row_adj, pady=5)
    lbl10_B_3.grid(column=18, row=3+row_adj, pady=5)
    spin10_C_3.grid(column=19,row=3+row_adj, pady=5)
    label10_h2_3.grid(column=20,row=3+row_adj, pady=5)
    spin10_D_3.grid(column=21,row=3+row_adj, pady=5)
    label10_m2_3.grid(column=22,row=3+row_adj, pady=5)
    rad10_B_3.grid(column=23, row=3+row_adj, padx=15, pady=5)
    rad10_C_3.grid(column=24, row=3+row_adj, pady=5)

    btn10.grid(column=25, row=4+row_adj, padx=25, pady=5)
