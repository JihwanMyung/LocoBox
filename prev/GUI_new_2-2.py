...
# for Box2
global box2_set,hourOn2_1, minOn2_1,  hourOff2_1,     minOff2_1,   dark2_1, light2_1
...
# for Box3
global box3_set,hourOn3_1, minOn3_1,  hourOff3_1,     minOff3_1,   dark3_1, light3_1
...
# for Box4
global box4_set,hourOn4_1, minOn4_1,  hourOff4_1,     minOff4_1,   dark4_1, light4_1
...
# for Box5
global box5_set,hourOn5_1, minOn5_1,  hourOff5_1,     minOff5_1,   dark5_1, light5_1
...
# for Box6
global box6_set,hourOn6_1, minOn6_1,  hourOff6_1,     minOff6_1,   dark6_1, light6_1
...
# for Box7
global box7_set,hourOn7_1, minOn7_1,  hourOff7_1,     minOff7_1,   dark7_1, light7_1
...
# for Box8
global box8_set,hourOn8_1, minOn8_1,  hourOff8_1,     minOff8_1,   dark8_1, light8_1
...
# for Box9
global box9_set,hourOn9_1, minOn9_1,  hourOff9_1,     minOff9_1,   dark9_1, light9_1
...
# for Box10
global box10_set,hourOn10_1, minOn10_1,  hourOff10_1,     minOff10_1,   dark10_1, light10_1
...
# Presets (defaults for global variables)
# for Box1
box1_set  = 0 # Phase 1
hourOn1_1 = 7
minOn1_1  = 0
hourOff1_1= 19
minOff1_1 = 0                            
dark1_1   ='1' # default is DD (var1_1=2)
light1_1  ='0'
date1_2   = 12 # Phase 2
month1_2  = 12
year1_2   = 2020
...
hourOff2_1= 19
minOff2_1 = 0                            
dark2_1   ='1' # default is DD (var2_1=2)
light2_1  ='0'
date2_2   = 12 # Phase 2
month2_2  = 12
year2_2   = 2020
...
hourOff3_1= 19
minOff3_1 = 0                            
dark3_1   ='1' # default is DD (var3_1=2)
light3_1  ='0'
date3_2   = 12 # Phase 2
month3_2  = 12
year3_2   = 2020
...
hourOff4_1= 19
minOff4_1 = 0                            
dark4_1   ='1' # default is DD (var4_1=2)
light4_1  ='0'
date4_2   = 12 # Phase 2
month4_2  = 12
year4_2   = 2020
...
hourOff5_1= 19
minOff5_1 = 0                            
dark5_1   ='1' # default is DD (var5_1=2)
light5_1  ='0'
date5_2   = 12 # Phase 2
month5_2  = 12
year5_2   = 2020
...
hourOff6_1= 19
minOff6_1 = 0                            
dark6_1   ='1' # default is DD (var6_1=2)
light6_1  ='0'
date6_2   = 12 # Phase 2
month6_2  = 12
year6_2   = 2020
...
hourOff7_1= 19
minOff7_1 = 0                            
dark7_1   ='1' # default is DD (var7_1=2)
light7_1  ='0'
date7_2   = 12 # Phase 2
month7_2  = 12
year7_2   = 2020
...
hourOff8_1= 19
minOff8_1 = 0                            
dark8_1   ='1' # default is DD (var8_1=2)
light8_1  ='0'
date8_2   = 12 # Phase 2
month8_2  = 12
year8_2   = 2020
...
hourOff9_1= 19
minOff9_1 = 0                            
dark9_1   ='1' # default is DD (var9_1=2)
light9_1  ='0'
date9_2   = 12 # Phase 2
month9_2  = 12
year9_2   = 2020
...
hourOff10_1= 19
minOff10_1 = 0                            
dark10_1   ='1' # default is DD (var10_1=2)
light10_1  ='0'
date10_2   = 12 # Phase 2
month10_2  = 12
year10_2   = 2020
...
def connect(): # Start to connect and call get_data - Link to Start in Recording menu
    ...
    try:
        ...
        print('Enter Baud rate and Port number (COM or tty).')
        return
...
def disconnect(): #disconnect the serial_obj (haven't make it work yet)
    try:
        ...
        print('Forced disconnection failed.')
        return
...
if __name__ == '__main__':
    ...
    tab_control.add(tab11, text='All')
    ...
    baud   = Label(text =  'Baud rate').place(x = 370, y = 360)
    timeout = Label(text = 'Time out').place(x= 370, y=320)
    ...
    baud_entry.place(x = 445, y = 360)
    timeout_entry = Entry(width = 4)
    timeout_entry.place(x=445,y=320)
    ...
    var11_1=StringVar()
    var11_1.set(str(hourOn1_1))

    param11_1 = Label(tab11, textvariable=var11_1)
#    param11_1.pack()

    param11_1.grid(column=2,row=2,padx=2,pady=0)
