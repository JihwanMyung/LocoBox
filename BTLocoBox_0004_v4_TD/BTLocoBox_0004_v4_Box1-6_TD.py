...
def show_conf(): # Show schedule configuration
    ...
    if light1_2=='0' and dark1_2=='0':
        ...
        box1pha2text.set(year1_2+'/'+month1_2+'/'+date1_2+' '+hourFrom1_2+':'+minuteFrom1_2+' | '+hourOn1_2+':'+minOn1_2+' on>'+hourOff1_2+':'+minOff1_2+' off'+ ' (' + tcycle_1_2 + 'h)')
        
    if light1_2=='0' and dark1_2=='1':
        box1pha2text.set('                                ')
        
        box1pha2text.set(year1_2+'/'+month1_2+'/'+date1_2+' '+hourFrom1_2+':'+minuteFrom1_2+' | '+'DD'+ ' (' + tcycle_1_2 + 'h)')
        
    if light1_2=='1' and dark1_2=='0':
        box1pha2text.set('                                ')
        
        box1pha2text.set(year1_2+'/'+month1_2+'/'+date1_2+' '+hourFrom1_2+':'+minuteFrom1_2+' | '+'LL'+ ' (' + tcycle_1_2 + 'h)')
    ...
    if light1_3=='0' and dark1_3=='0':
        ...
        box1pha3text.set(year1_3+'/'+month1_3+'/'+date1_3+' '+hourFrom1_3+':'+minuteFrom1_3+' | '+hourOn1_3+':'+minOn1_3+' on>'+hourOff1_3+':'+minOff1_3+' off'+ ' (' + tcycle_1_3 + 'h)')
        
    if light1_3=='0' and dark1_3=='1':
        box1pha3text.set('                                ')
        
        box1pha3text.set(year1_3+'/'+month1_3+'/'+date1_3+' '+hourFrom1_3+':'+minuteFrom1_3+' | '+'DD'+ ' (' + tcycle_1_3 + 'h)')
        
    if light1_3=='1' and dark1_3=='0':
        box1pha3text.set('                                 ')
        
        box1pha3text.set(year1_3+'/'+month1_3+'/'+date1_3+' '+hourFrom1_3+':'+minuteFrom1_3+' | '+'LL'+ ' (' + tcycle_1_3 + 'h)')
    ...
    if light1_4=='0' and dark1_4=='0':
        ...
        box1pha4text.set(year1_4+'/'+month1_4+'/'+date1_4+' '+hourFrom1_4+':'+minuteFrom1_4+' | '+hourOn1_4+':'+minOn1_4+' on>'+hourOff1_4+':'+minOff1_4+' off'+ ' (' + tcycle_1_4 + 'h)')
        
    if light1_4=='0' and dark1_4=='1':
        box1pha4text.set('                                ')
        
        box1pha4text.set(year1_4+'/'+month1_4+'/'+date1_4+' '+hourFrom1_4+':'+minuteFrom1_4+' | '+'DD'+ ' (' + tcycle_1_4 + 'h)')
        
    if light1_4=='1' and dark1_4=='0':
        box1pha4text.set('                                 ')
        
        box1pha4text.set(year1_4+'/'+month1_4+'/'+date1_4+' '+hourFrom1_4+':'+minuteFrom1_4+' | '+'LL'+ ' (' + tcycle_1_4 + 'h)')
    ...
    if light1_5=='0' and dark1_5=='0':
        ...
        box1pha5text.set(year1_5+'/'+month1_5+'/'+date1_5+' '+hourFrom1_5+':'+minuteFrom1_5+' | '+hourOn1_5+':'+minOn1_5+' on>'+hourOff1_5+':'+minOff1_5+' off'+ ' (' + tcycle_1_5 + 'h)')
        
    if light1_5=='0' and dark1_5=='1':
        box1pha5text.set('                                ')
        
        box1pha5text.set(year1_5+'/'+month1_5+'/'+date1_5+' '+hourFrom1_5+':'+minuteFrom1_5+' | '+'DD'+ ' (' + tcycle_1_5 + 'h)')
        
    if light1_5=='1' and dark1_5=='0':
        box1pha5text.set('                                 ')
        
        box1pha5text.set(year1_5+'/'+month1_5+'/'+date1_5+' '+hourFrom1_5+':'+minuteFrom1_5+' | '+'LL'+ ' (' + tcycle_1_5 + 'h)')
    ...
    if light1_6=='0' and dark1_6=='0':
        ...
        box1pha6text.set(year1_6+'/'+month1_6+'/'+date1_6+' '+hourFrom1_6+':'+minuteFrom1_6+' | '+hourOn1_6+':'+minOn1_6+' on>'+hourOff1_6+':'+minOff1_6+' off'+ ' (' + tcycle_1_6 + 'h)')
        
    if light1_6=='0' and dark1_6=='1':
        box1pha6text.set('                                ')
        
        box1pha6text.set(year1_6+'/'+month1_6+'/'+date1_6+' '+hourFrom1_6+':'+minuteFrom1_6+' | '+'DD'+ ' (' + tcycle_1_6 + 'h)')
        
    if light1_6=='1' and dark1_6=='0':
        box1pha6text.set('                                 ')
        
        box1pha6text.set(year1_6+'/'+month1_6+'/'+date1_6+' '+hourFrom1_6+':'+minuteFrom1_6+' | '+'LL'+ ' (' + tcycle_1_6 + 'h)')
    ...
    if light1_7=='0' and dark1_7=='0':
        ...
        box1pha7text.set(year1_7+'/'+month1_7+'/'+date1_7+' '+hourFrom1_7+':'+minuteFrom1_7+' | '+hourOn1_7+':'+minOn1_7+' on>'+hourOff1_7+':'+minOff1_7+' off'+ ' (' + tcycle_1_7 + 'h)')
        
    if light1_7=='0' and dark1_7=='1':
        box1pha7text.set('                                ')
        
        box1pha7text.set(year1_7+'/'+month1_7+'/'+date1_7+' '+hourFrom1_7+':'+minuteFrom1_7+' | '+'DD'+ ' (' + tcycle_1_7 + 'h)')
        
    if light1_7=='1' and dark1_7=='0':
        box1pha7text.set('                                 ')
        
        box1pha7text.set(year1_7+'/'+month1_7+'/'+date1_7+' '+hourFrom1_7+':'+minuteFrom1_7+' | '+'LL'+ ' (' + tcycle_1_7 + 'h)')
    ...
    if light1_8=='0' and dark1_8=='0':
        ...
        box1pha8text.set(year1_8+'/'+month1_8+'/'+date1_8+' '+hourFrom1_8+':'+minuteFrom1_8+' | '+hourOn1_8+':'+minOn1_8+' on>'+hourOff1_8+':'+minOff1_8+' off'+ ' (' + tcycle_1_8 + 'h)')
        
    if light1_8=='0' and dark1_8=='1':
        box1pha8text.set('                                ')
        
        box1pha8text.set(year1_8+'/'+month1_8+'/'+date1_8+' '+hourFrom1_8+':'+minuteFrom1_8+' | '+'DD'+ ' (' + tcycle_1_8 + 'h)')
        
    if light1_8=='1' and dark1_8=='0':
        box1pha8text.set('                                 ')
        
        box1pha8text.set(year1_8+'/'+month1_8+'/'+date1_8+' '+hourFrom1_8+':'+minuteFrom1_8+' | '+'LL'+ ' (' + tcycle_1_8 + 'h)')
    ...
    if light1_9=='0' and dark1_9=='0':
        ...
        box1pha9text.set(year1_9+'/'+month1_9+'/'+date1_9+' '+hourFrom1_9+':'+minuteFrom1_9+' | '+hourOn1_9+':'+minOn1_9+' on>'+hourOff1_9+':'+minOff1_9+' off'+ ' (' + tcycle_1_9 + 'h)')
        
    if light1_9=='0' and dark1_9=='1':
        box1pha9text.set('                                ')
        
        box1pha9text.set(year1_9+'/'+month1_9+'/'+date1_9+' '+hourFrom1_9+':'+minuteFrom1_9+' | '+'DD'+ ' (' + tcycle_1_9 + 'h)')
        
    if light1_9=='1' and dark1_9=='0':
        box1pha9text.set('                                 ')
        
        box1pha9text.set(year1_9+'/'+month1_9+'/'+date1_9+' '+hourFrom1_9+':'+minuteFrom1_9+' | '+'LL'+ ' (' + tcycle_1_9 + 'h)')
    ...
    if light1_10=='0' and dark1_10=='0':
        ...
        box1pha10text.set(year1_10+'/'+month1_10+'/'+date1_10+' '+hourFrom1_10+':'+minuteFrom1_10+' | '+hourOn1_10+':'+minOn1_10+' on>'+hourOff1_10+':'+minOff1_10+' off'+ ' (' + tcycle_1_10 + 'h)')
        
    if light1_10=='0' and dark1_10=='1':
        box1pha10text.set('                                ')
        
        box1pha10text.set(year1_10+'/'+month1_10+'/'+date1_10+' '+hourFrom1_10+':'+minuteFrom1_10+' | '+'DD'+ ' (' + tcycle_1_10 + 'h)')
        
    if light1_10=='1' and dark1_10=='0':
        box1pha10text.set('                                 ')
        
        box1pha10text.set(year1_10+'/'+month1_10+'/'+date1_10+' '+hourFrom1_10+':'+minuteFrom1_10+' | '+'LL'+ ' (' + tcycle_1_10 + 'h)')
    ...
    if light1_11=='0' and dark1_11=='0':
        ...
        box1pha11text.set(year1_11+'/'+month1_11+'/'+date1_11+' '+hourFrom1_11+':'+minuteFrom1_11+' | '+hourOn1_11+':'+minOn1_11+' on>'+hourOff1_11+':'+minOff1_11+' off'+ ' (' + tcycle_1_11 + 'h)')
        
    if light1_11=='0' and dark1_11=='1':
        box1pha11text.set('                                ')
        
        box1pha11text.set(year1_11+'/'+month1_11+'/'+date1_11+' '+hourFrom1_11+':'+minuteFrom1_11+' | '+'DD'+ ' (' + tcycle_1_11 + 'h)')
        
    if light1_11=='1' and dark1_11=='0':
        box1pha11text.set('                                 ')
        
        box1pha11text.set(year1_11+'/'+month1_11+'/'+date1_11+' '+hourFrom1_11+':'+minuteFrom1_11+' | '+'LL'+ ' (' + tcycle_1_11 + 'h)')
    ...
    if light1_12=='0' and dark1_12=='0':
        ...
        box1pha12text.set(year1_12+'/'+month1_12+'/'+date1_12+' '+hourFrom1_12+':'+minuteFrom1_12+' | '+hourOn1_12+':'+minOn1_12+' on>'+hourOff1_12+':'+minOff1_12+' off'+ ' (' + tcycle_1_12 + 'h)')
        
    if light1_12=='0' and dark1_12=='1':
        box1pha12text.set('                                ')
        
        box1pha12text.set(year1_12+'/'+month1_12+'/'+date1_12+' '+hourFrom1_12+':'+minuteFrom1_12+' | '+'DD'+ ' (' + tcycle_1_12 + 'h)')
        
    if light1_12=='1' and dark1_12=='0':
        box1pha12text.set('                                 ')
        
        box1pha12text.set(year1_12+'/'+month1_12+'/'+date1_12+' '+hourFrom1_12+':'+minuteFrom1_12+' | '+'LL'+ ' (' + tcycle_1_12 + 'h)')
